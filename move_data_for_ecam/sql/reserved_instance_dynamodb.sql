...
account_338834536339 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_dynamodb 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_338834536339"."reserved_instance_dynamodb"
),
...
account_856753954371 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_dynamodb 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_856753954371"."reserved_instance_dynamodb"
),
...
UNION ALL
SELECT title, reserved_instance_dynamodb FROM account_338834536339
UNION ALL
...
UNION ALL
SELECT title, reserved_instance_dynamodb FROM account_856753954371
UNION ALL
