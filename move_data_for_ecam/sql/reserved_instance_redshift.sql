WITH account_434519024304 AS (
   ...
   FROM 
       "production_a2b_common_aws_aggregate_shared"."reserved_instance_redshift"
),
account_014229765626 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_014229765626"."reserved_instance_redshift"
),
account_014730125768 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_014730125768"."reserved_instance_redshift"
),
account_015166320012 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_015166320012"."reserved_instance_redshift"
),
account_023280770555 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_023280770555"."reserved_instance_redshift"
),
account_034783791145 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_034783791145"."reserved_instance_redshift"
),
account_073858585757 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_073858585757"."reserved_instance_redshift"
),
account_127466939911 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_127466939911"."reserved_instance_redshift"
),
account_189585356497 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_189585356497"."reserved_instance_redshift"
),
account_226060598830 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_226060598830"."reserved_instance_redshift"
),
account_247364657386 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_247364657386"."reserved_instance_redshift"
),
...
account_341267347886 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_341267347886"."reserved_instance_redshift"
),
account_346402807177 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_346402807177"."reserved_instance_redshift"
),
account_366519242445 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_366519242445"."reserved_instance_redshift"
),
account_394759194433 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_394759194433"."reserved_instance_redshift"
),
account_430092958156 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_430092958156"."reserved_instance_redshift"
),
account_460564462217 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_460564462217"."reserved_instance_redshift"
),
account_507776553901 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_507776553901"."reserved_instance_redshift"
),
account_514831055183 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_514831055183"."reserved_instance_redshift"
),
account_552721663264 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_552721663264"."reserved_instance_redshift"
),
account_582087840222 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_582087840222"."reserved_instance_redshift"
),
account_634487139226 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_634487139226"."reserved_instance_redshift"
),
account_638346777360 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_638346777360"."reserved_instance_redshift"
),
account_672604971719 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_672604971719"."reserved_instance_redshift"
),
...
account_862340440120 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_862340440120"."reserved_instance_redshift"
),
account_863071450033 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_863071450033"."reserved_instance_redshift"
),
account_875144205584 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_875144205584"."reserved_instance_redshift"
),
account_884103735193 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_884103735193"."reserved_instance_redshift"
),
account_897706971707 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_897706971707"."reserved_instance_redshift"
),
account_918821427740 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_918821427740"."reserved_instance_redshift"
),
account_955737177772 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_955737177772"."reserved_instance_redshift"
),
account_963065819957 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_963065819957"."reserved_instance_redshift"
),
account_969325077577 AS (
   SELECT 
       ...
       count(*) AS reserved_instance_redshift 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_969325077577"."reserved_instance_redshift"
),
