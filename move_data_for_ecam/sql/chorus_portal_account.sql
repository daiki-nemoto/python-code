WITH account_434519024304 AS (
   ...
   FROM 
       "production_a2b_common_aws_aggregate_shared"."chorus_portal_account"
),
account_014229765626 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_014229765626"."chorus_portal_account"
),
account_014730125768 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_014730125768"."chorus_portal_account"
),
account_015166320012 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_015166320012"."chorus_portal_account"
),
account_023280770555 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_023280770555"."chorus_portal_account"
),
account_034783791145 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_034783791145"."chorus_portal_account"
),
account_073858585757 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_073858585757"."chorus_portal_account"
),
account_127466939911 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_127466939911"."chorus_portal_account"
),
account_189585356497 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_189585356497"."chorus_portal_account"
),
account_226060598830 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_226060598830"."chorus_portal_account"
),
account_247364657386 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_247364657386"."chorus_portal_account"
),
...
account_341267347886 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_341267347886"."chorus_portal_account"
),
account_346402807177 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_346402807177"."chorus_portal_account"
),
account_366519242445 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_366519242445"."chorus_portal_account"
),
account_394759194433 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_394759194433"."chorus_portal_account"
),
account_430092958156 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_430092958156"."chorus_portal_account"
),
account_460564462217 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_460564462217"."chorus_portal_account"
),
account_507776553901 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_507776553901"."chorus_portal_account"
),
account_514831055183 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_514831055183"."chorus_portal_account"
),
account_552721663264 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_552721663264"."chorus_portal_account"
),
account_582087840222 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_582087840222"."chorus_portal_account"
),
account_634487139226 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_634487139226"."chorus_portal_account"
),
account_638346777360 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_638346777360"."chorus_portal_account"
),
account_672604971719 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_672604971719"."chorus_portal_account"
),
...
account_862340440120 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_862340440120"."chorus_portal_account"
),
account_863071450033 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_863071450033"."chorus_portal_account"
),
account_875144205584 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_875144205584"."chorus_portal_account"
),
account_884103735193 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_884103735193"."chorus_portal_account"
),
account_897706971707 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_897706971707"."chorus_portal_account"
),
account_918821427740 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_918821427740"."chorus_portal_account"
),
account_955737177772 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_955737177772"."chorus_portal_account"
),
account_963065819957 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_963065819957"."chorus_portal_account"
),
account_969325077577 AS (
   SELECT 
       ...
       count(*) AS chorus_portal_account 
   FROM 
       "production_a2b_common_aws_aggregate_dedicated_969325077577"."chorus_portal_account"
),
